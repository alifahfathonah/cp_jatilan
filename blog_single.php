...
<section id="blog" class="container">
    ...
    <div class="blog">
        <div class="row">
            <div class="col-md-8">
                <?php 
                $sqlBlog = $mysqli->query("SELECT b.id, b.title, b.image, b.content, c.name, b.date_created, b.date_updated, p.nick_name FROM jtl_blogs b JOIN jtl_profiles p ON b.profile_id = p.id JOIN jtl_category_blog c ON b.category_blog = c.id WHERE b.id='".$_GET['id']."'");
