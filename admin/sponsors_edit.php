                    ...
                    ?>
                            ...
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form class="form-horizontal" action="sponsors_edit_process.php" method="post" enctype="multipart/form-data">
                                            ...
                                            while($row = $sql->fetch_array()){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="sponsors_detail_edit.php?id=<?php echo $row['id'] ?>" class="btn btn-mini btn-warning" title="Edit">
                                                            <i class="icon-pencil icon-white"></i>
                                                        </a>
