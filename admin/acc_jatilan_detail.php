        ...
        <?php include "include/_inc_sidebar.php" ?>
                <div class="span9" id="content">
                    <div class="row-fluid">
                        <!-- block -->
                        <?php
                        $sql = $mysqli->query("SELECT a.id, a.name, a.image, a.descriptions, a.date_created, a.profile_id, p.nick_name, u.email  FROM jtl_accessories a JOIN jtl_users u ON a.user_id = u.id JOIN jtl_profiles p ON a.profile_id = p.id WHERE a.id='" . $_GET['id'] . "' ");
                        $row = $sql->fetch_array();
                        ?>
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left"><i class="icon-book"></i> Accessories Post by <?php echo $row['email']; ?></div>
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                    ...
                                    <div class="span8">
                                        <div>
                                            <p>
                                                <img src="<?php echo $row['image'] ?>" style="width: 100%; height: 400px">
                                            </p>
                                            <p>
