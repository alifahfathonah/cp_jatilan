                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" id="content">
                        <div class="row-fluid">
                            <!-- block -->
                            <?php
                            $sql = $mysqli->query("SELECT m.id, m.member_name, m.address, m.gender, m.image, m.self_status, m.motto, m.facebook_url, m.twitter_url, m.instagram_url, m.active_status, m.date_created, m.date_updated, c.name, u.email, p.nick_name FROM jtl_members m JOIN jtl_category_members c ON m.category_member = c.id JOIN jtl_users u ON u.id = m.user_id JOIN jtl_profiles p ON p.id = m.profile_id");
                            ?>
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    ...
                                    <div class="pull-right">
                                        <a href="members_add.php" class="badge badge-inverse">
                                            <span class="icon icon-white icon-plus"></span> Add </a>
                                    ...
                                    <?php while ($row = $sql->fetch_array()) { ?>
                                        <div class="row-fluid">
                                            ...
                                            <div class="span3">
                                                ...
                                                <p>
                                                    <a href="member_detail.php?id=<?php echo $row['id'] ?>" class="btn btn-mini" title="Details">
