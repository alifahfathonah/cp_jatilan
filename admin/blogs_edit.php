    ...
    if ($_SESSION['status'] == 1) {
        if ($_SESSION['id'] == $row['user_id']) {
            ...
            <?php include "include/_inc_sidebar.php" ?>
                    ...
                    <?php 
                    $sql2 = $mysqli->query("SELECT b.id, b.title, b.content FROM jtl_blogs b JOIN jtl_category_blog c ON b.category_blog = c.id WHERE b.id='" . $_GET['id'] . "' ");
                        ...
                        <div class="row-fluid">
                            ...
                            <div class="block">
                                <div class="navbar navbar-inner block-header">
                                    <div class="muted pull-left"><i class="icon-book"></i> Blogs</div>
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        <form class="form-horizontal" action="blog_edit_process.php" method="post" enctype="multipart/form-data">
                                            <input type="hidden" name="id" value="<?php echo $row2['id'] ?>">
                                            <fieldset>
                                                <div class="control-group">
                                                    <label class="control-label"><b>Title</b> </label>
                                                    <div class="controls">
                                                        <input type="text" class="span6" name="title" required="required" value="<?php echo $row2['title']; ?>">
                                                    </div>
                                                </div>
                                                <div class="control-group">
                                                    <label class="control-label" for="textarea2"><b>Content</b> </label>
                                                    <div class="controls">
                                                        <textarea class="input-xlarge textarea" placeholder="" style="width: 680px; height: 200px" name="content" required="required"><?php echo $row2['content'] ?></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <select name="category_blog" required="required">
                                                            <?php
                                                            $sql3 = $mysqli->query("SELECT * FROM jtl_category_blog");
