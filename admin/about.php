                            ...
                            <div class="block">
                                ...
                                <div class="block-content collapse in">
                                    <div class="span12">
                                        ...
                                        $data = $mysqli->query("SELECT * FROM jtl_about");
                                        if (mysqli_num_rows($data) == 1) {
                                            while ($row = $data->fetch_array()) {
                                                ...
                                                <fieldset>
                                                    <dl class="dl-horizontal">
                                                        <dt>Title </dt>
                                                        <dd><p class="help-block"><?php echo $row['title']; ?></p></dd>
                                                    </dl>
                                                    <dl class="dl-horizontal">
                                                        <dt>Content </dt>
                                                        <dd><p class="help-block" style="text-align: justify"><?php echo $row['content']; ?></p></dd>
                                                    </dl>

                                                    <dl class="dl-horizontal">
                                                        <dt>Image </dt>
                                                        <dd><p class="help-block"><img class="thumbnail" src="<?php echo $row['image']; ?>" style="width: 95%; height: 300px"> </p></dd>
                                                    </dl>

                                                    <div class="form-actions" style="padding-left: 180px">
                                                        <a href="about_edit.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">
                                                            <i class="icon-pencil icon-white"></i>
                                                            Edit
                                                        </a>
                                                        <a href="about_delete.php?id=<?php echo $row['id'] ?>" class="btn btn-danger" onclick="return confirm ('Anda yakin ?')">
                                            ...
                                            <div class="span12">
                                                <div class="alert alert-info">
                                                    ...
                                                    <strong>Info!</strong> Informasi tentang web anda masih kosong. Silahkan diisi terlebih dahulu.
                                                </div>
                                            </div>
                                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="about_add_process.php">
                                                ...
                                                <fieldset>
                                                    <div class="control-group">
                                                        ...
                                                        <div class="controls">
                                                            <input type="text" class="span6" name="title" required="required">
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
                                                        <label class="control-label" for="textarea2"><b>Content</b> </label>
                                                        <div class="controls">
                                                            <textarea class="input-xlarge textarea" placeholder="" style="width: 680px; height: 200px" name="content" required="required"></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="control-group">
